# -*- coding: utf-8 -*-
"""
Shared chapter metadata: which tracks/groups/chapters exist, what folder and
title each one has. Single source of truth for both _build_index.py (handbook
+ quiz build) and _build_audiobook.py (narration/audio build) -- previously
_build_audiobook.py kept its own separate, hand-maintained copy of this data
and silently went stale every time chapters were added/renumbered/moved into
per-track folders, until it stopped finding any chapter file at all.
"""
import os, glob
